...
public class TelaListagemOS extends javax.swing.JFrame {
    ...
    public TelaListagemOS() {
        try {
            initComponents();
            if(this.getExtendedState()!= TelaListagemOS.MAXIMIZED_BOTH){
    ...
    private void initComponents() {
        ...
        jButtonNovaOS.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jTableListagemDeOS.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Número", "Colaborador", "Veículo", "Cliente", "QTD Peças", "QTD Serviços", "Status"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListagemOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListagemOS().setVisible(true);
            }
        });
    }
