...
public class TelaExibirServicos extends javax.swing.JFrame {
    ...
    public TelaExibirServicos() {
        initComponents();
         if(this.getExtendedState()!= TelaExibirServicos.MAXIMIZED_BOTH){
            this.setExtendedState(TelaExibirServicos.MAXIMIZED_BOTH);
        }
    ...
    private void jButtonCadastrarVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarVeiculoActionPerformed
        // TODO add your handling code here:
        TelaExibirServicos veiculo = new TelaExibirServicos();
