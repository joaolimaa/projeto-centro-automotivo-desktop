 ...
 * @author Dell
 */
public class TelaExibirPeças extends javax.swing.JFrame {

    /**
     * Creates new form TelaTechnocar
     */
    public TelaExibirPeças() {
        initComponents();
         if(this.getExtendedState()!= TelaExibirPeças.MAXIMIZED_BOTH){
            this.setExtendedState(TelaExibirPeças.MAXIMIZED_BOTH);
        }
    ...
    private void jButtonCadastrarVeiculoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarVeiculoActionPerformed
        // TODO add your handling code here:
        TelaExibirPeças veiculo = new TelaExibirPeças();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExibirPeças.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExibirPeças().setVisible(true);
            }
        });
    }
